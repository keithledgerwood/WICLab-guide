...
Single Tick Javascript Put this in the right box: `javascript
 {{Office365.TenantID}}` and hit enter
Put this in the right box: ```{{Office365.TenantID}}``` and hit enter
Python Put this in the right box: ```python
 {{Office365.TenantID}}``` and hit enter
javascript Put this in the right box: ```javascript
 {{Office365.TenantID}}``` and hit enter
